...
export const Contact = () => {
    return (
        <div id="contact" className="w-[1280px] m-auto">
            <div className="py-[150px] px-[100px] text-center">
                ...
                <ScrollReveal direction="up" delay={0.3}>
                    <p className="text-[#8892B0] max-w-[600px] mx-auto text-[18px] mb-10 leading-relaxed">
