...
export const Work = () => {
    ...
    return (
        <div
            id="work"
            className="max-w-[1280px] mx-auto px-4 sm:px-6 md:px-8 py-[100px]"
        >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                {projects.map((project, index) => (
                    <ScrollReveal
                        ...
                        delay={0.2 + index * 0.1}
                    >
                        <div className="bg-[#112240] rounded-xl p-6 hover:scale-[1.02] transition-all duration-300 hover:shadow-lg hover:shadow-[#58FFDA]/10 group">
